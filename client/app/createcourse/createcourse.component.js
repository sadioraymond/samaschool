...
export class CreatecourseComponent {
    ...
    getCurrentUser;
    isLoggedIn;
    constructor(jsFonctions, categorieProvider, souscategorieProvider, Auth) {
    ...
    nextClick() {
        console.log('Kane la', this.getCurrentUser().name);
...
CreatecourseComponent.$inject = ["jsFonctions", "categorieProvider", "souscategorieProvider", "Auth"];
