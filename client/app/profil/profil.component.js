...
export class ProfilComponent {
    ...
    multerProvider;
    /*@ngInject*/
    constructor(jsFonctions, categorieProvider, souscategorieProvider, Auth, etablissementProvider, suiviCoursProvider, coursProvider, userProvider, $stateParams, $state, $location, ouvreDialogProvider, $filter, $timeout, $log, multerProvider) {
        this.$log = $log
...
ProfilComponent.$inject = ["jsFonctions", "categorieProvider", "souscategorieProvider", "Auth", "etablissementProvider", "suiviCoursProvider", "coursProvider", "userProvider", "$stateParams", "$state", "$location", "ouvreDialogProvider", "$filter", "$timeout", "$log", "multerProvider"];
